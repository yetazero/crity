...
Customizable damage numbers, a target health HUD, and combat highlights for Hytale.
...
Crity 3.2.4 supports **Hytale 0.7.0-PRE1**. Check the game version listed on the release before downloading.

1. Download `Crity-3.2.4.jar` from [Releases](https://github.com/yetazero/crity/releases/latest).
...
Use the settings panel to edit **Damage**, **Color rules**, **Health HUD**, and **Highlight**.
